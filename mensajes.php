                    ...
                    <div class='row'>
                        <div class='col-md-8 col-md-offset-2'>
                            <div class='alert alert-success'>
                                <button class='close' data-dismiss='alert'><span>&times;</span></button>
                                <strong>El contenido fue agregado exitosamente, si quieres modificar el contenido puedes dirigirte a la siguiente seccion en tu <a href='panel'>panel usuario</a></strong>
                            </div>
                        </div>
                    </div>
                ";
