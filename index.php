...
<meta name="description" content="Somos un sitio en donde se recomiendan y se comparten contenidos tales como ejercicios resueltos, de prÃ¡ctica, videos, apuntes de cuadernos, aplicaciones digitales, textos en lÃ­nea, formularios, presentaciones y sitios web relacionados con las matemÃ¡ticas y las ciencias, poseemos un sistema de organizaciÃ³n de la informaciÃ³n que te permitirÃ¡ encontrar algÃºn material mÃ¡s sencillamente ademÃ¡s de que los contenidos son calificados por la comunidad ">
...
<?php 
	...
	include("./vistas_principales/header.php");
?>
