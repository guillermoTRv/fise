<div class="panel panel-default">
									<div class="panel-heading" role='tab' id='heading5'>
                                        <div class="row">
											...
											<div class="col-md-6 col-sm-7 ">
												<h3>
													<a class='avn' href="#collapse5" data-toggle='collapse' data-parent='#accordion5'>
															Valores y vectores <?php $n="característicos"; echo utf8_encode($n); ?> 
													</a>
											    </h3>
											</div>
										</div>
								...
								$consulta="SELECT * FROM unidades_materias WHERE materia='$materia' order by id_unidades asc LIMIT 15,4";
