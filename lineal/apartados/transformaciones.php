<div class="panel panel-default">
									<div class="panel-heading" role='tab' id='heading4'>
                                        <div class="row">
											...
											<div class="col-md-5 col-sm-6 ">
												<h3>
													<a class='avn' href="#collapse4" data-toggle='collapse' data-parent='#accordion4'>
								...
								$consulta="SELECT * FROM unidades_materias WHERE materia='$materia' order by id_unidades asc LIMIT 11,4";
