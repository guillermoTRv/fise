...
?>
<?php include("../scripts/panel_contenidos/principales/redireccionamiento_listas.php"); ?>
<?php 
echo "
<center><a href='?un=$u&sub=true' class='aind'>Compartir un material</a></center><br>"; ?>
<center><a href="<?php echo $ruta."/foros.php" ?>" class="aind">Ir al foro de la materia</a></center><br>
...
<?php 
    ...
    if (!seccion()) {
        include("../scripts/panel_contenidos/principales/form_agregarseccionsin.php");
    }
    else{
    	if ($tm=='') {
    		include("../scripts/panel_contenidos/principales/form_agregarseccion.php");
    	}
    	if ($tm!='') {
    		include("../scripts/panel_contenidos/principales/form_agregarsecciontm.php");
    	}
