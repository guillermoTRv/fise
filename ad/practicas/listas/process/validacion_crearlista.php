		...
		if ($name!='' and $clasificacion!='' and $nivel!='' and $materia!='') {
			...
			if ($vbn==0) {
					...
					$form_n="&nbsp;&nbsp;<form id='crear_si' method='POST' enctype='multipart/form-data'>
							...
							<input type='hidden' value='$modulo' name='modulo_m'>
							".$btn_dos."</form>";
					...
					$mens="<p style='margin-top:10px;'>Estos son los datos que ingresaste y que se iran a subir, puedes corregir aprentando el boton cancelar</p><p>Titulo de lista: $name</p> <p>Clasificacion: $clasificacion</p> <p>Nivel: $nivel</p> <p>Materia: $materia</p> <p>Modulo: $modulo</p><div class='row'><div class='col-md-1'>".$form_n."</div><div class='col-md-2'>".$form_a."</div></div>";
					$input="";
					$r=[	
						'uno' =>$mens,
						'dos' =>$input
